...
var ebj = EBookJapan{
	[]Option{
		&BoolOption{K: "Lossless", V: false, Required: false,
...
func (ebj *EBookJapan) Options() []Option {
	return ebj.options
}

func (ebj *EBookJapan) DownloadGenerator(url string) (dlgen func() Downloader, length int) {
	// Initialization.
	var ext string
	opts := OptionsToMap(ebj.options)
