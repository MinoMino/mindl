...
var dummy = Dummy{
	[]Option{
		&StringOption{K: "Hello", V: "World", Required: false},
		&StringOption{K: "I Like", V: "Potatoes", Required: false},
	},
}
...
func (d *Dummy) Options() []Option {
	return d.options
}

func (d *Dummy) DownloadGenerator(url string) (dlgen func() Downloader, length int) {
	// Initialization.
